...
\begin{itemize}
  ...
  \item Latest full local validation passed with 53 tests on Python 3.11.
  \item External data handoff, intake, and validation gates are implemented.
  \item Latest documentation and validation artifacts are synced to BistKA.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item HPC job scripts, external-data gates, and repeatable validation commands.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item Source-readiness and intake-validation gates run on BistKA.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item A provider manifest template now supports future licensed-data intake.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item Recent commits include full external config, provider request, intake checklist, and intake validator.
  \item Latest pushed commit before this slide refresh: \texttt{5eaab95}.
...
\begin{itemize}
  ...
  \item These are now explicit provider-file blockers, not unknown code tasks.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item External data templates for the five missing provider files.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item External intake validation for provider-file packages.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item Comprehensive introduction/literature-review PDF.
  \item External data handoff, provider request, and intake checklist.
  \item Data source documentation.
  \item Final artifact manifest.
  \item Intake validation CSV and Markdown reports.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item Save it at \texttt{data/reference/set50\_or\_set100\_universe.csv}.
  \item Run source-readiness and intake-validation gates.
  \item Only then rebuild OHLCV and feature tables.
\end{itemize}
\end{frame}
...
\begin{itemize}
  \item Follow \texttt{docs/full\_external\_rebuild.md}.
  \item Produce CSV and Markdown intake-validation reports.
  \item Run broader ablations, walk-forward validation, and regime tests.
  \item Report average, per-window stability, and failure cases.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item Latest verified full test count: 53 passed.
  \item Current blocker: five external provider files.
  \item Current status: reproducible pilot plus complete data handoff workflow.
\end{itemize}
\end{frame}
